    ...
    >
      <div className="flex flex-col w-full h-full justify-between gap-8">
        ...
        <div className="form-control w-full max-w-2xl">
          ...
          />
          {errors.lastName && (
            <p className="text-error pt-2 ">{errors.lastName.message}</p>
          )}
        </div>
        <div className="form-control w-full max-w-2xl">
          <input
          ...
          />
          {errors.companyName && (
            <p className="text-error pt-2 ">{errors.companyName.message}</p>
          )}
        </div>
        <div className="form-control w-full max-w-2xl">
          <input
        ...
        <div className="form-control w-full max-w-2xl">
          ...
          />
          {errors.adress && (
            <p className="text-error pt-2 ">{errors.adress.message}</p>
          )}
        </div>
        <div className="form-control w-full max-w-2xl">
          <input
          ...
          />
          {errors.city && (
            <p className="text-error pt-2 ">{errors.city.message}</p>
          )}
        </div>
        <div className="form-control w-full max-w-2xl">
          <input
          ...
          />
          {errors.oib && (
            <p className="text-error pt-2 ">{errors.oib.message}</p>
          )}
        </div>
        <div className="form-control w-full max-w-2xl">
          <input
          ...
          />
          {errors.phoneNumber && (
            <p className="text-error pt-2 ">{errors.phoneNumber.message}</p>
          )}
        </div>
