...
const Customers: React.FC = () => {
  ...
  const search = (data: Customer[]) => {
    const keys = ['firstName', 'lastName', 'companyName', 'email', 'oib', 'city', 'adress', 'phoneNumber']
    ...
    <>
      <div>
        ...
        <section className='flex flex-col border-solid border-2 bg-white rounded-lg shadow-md py-10 w-full'>
          <div className='flex justify-between pr-10 pb-36'>
            ...
            <table className='table w-full'>
              ...
              <tbody>
                {isLoading === 'loading' ? (
                  ...
                  sortedCustomers &&
                  search(sortedCustomers).map((singleCustomer: Customer, index: number) => {
